...
async function main() {
  ...
  const [criteriaRes, pubStatusRes, persStatusRes, sourceRes, tagGroupRes] = await Promise.all([
  ...
  for (const [name, res] of [["criteria", criteriaRes], ["publication_status", pubStatusRes], ["personal_status", persStatusRes], ["source", sourceRes], ["tag_group", tagGroupRes]]) {
