...
export const importRowSchema = z.object({
  ...
  angst: optionalScore,
  // 🔴 LEGADO: planilha antiga pode trazer as duas colunas. Aceitamos e gravamos como
  // `category_scores` histórico — recusar quebraria import que funcionava. Ver migration 198.
