...
import { buildPreferencesGroups } from "@/app/preferencias/sections"
import type { Role } from "@/lib/plans/roles"

/**
 * O índice da busca global — tudo que NÃO é obra.
 *
 * Obras vêm do servidor sob demanda (`searchWorkSuggestions`, o mesmo do `/titles`). O resto —
...
export interface SearchEntry {
   ...
   *
   * ⚠️ Sem isto, `/leitura` e `/conta` apareceriam para o visitante: o papel de um anônimo
...
const PAGES: Array<Omit<SearchEntry, "kind" | "crumb">> = [
  ...
  { id: "page-titles", title: "Catálogo", description: "todas as obras, com filtros e busca", href: "/titles", minRole: "leitor", requiresSession: false, iconName: "BookOpen" },
  ...
  { id: "page-sobre", title: "Sobre a SatorIA", description: "a marca, o método e os 4 passos", href: "/sobre", minRole: "leitor", requiresSession: false, iconName: "Info" },
  { id: "page-guia", title: "Guia do app", description: "como usar, do zero", href: "/guia", minRole: "leitor", requiresSession: false, iconName: "BookOpenText" },

  { id: "page-leitura", title: "Acompanhamento", description: "o que você está lendo e o ritmo de cada obra", href: "/leitura", minRole: "leitor", requiresSession: true, iconName: "BookMarked" },
  ...
  { id: "page-fila", title: "Fila de recomendação", description: "Veredito IA e previsão de Interesse", href: "/fila-recomendacao", minRole: "leitor", requiresSession: true, iconName: "Clock" },
  ...
  { id: "page-conta", title: "Minha conta", description: "plano, saldo e identidade", href: "/conta", minRole: "leitor", requiresSession: true, iconName: "UserCircle" },
  { id: "page-perfil", title: "Perfil de gosto", description: "o que a IA aprendeu sobre o que você gosta", href: "/conta/perfil", minRole: "leitor", requiresSession: true, iconName: "Sparkles" },
  { id: "page-painel", title: "Painel", description: "a forma da sua biblioteca em números", href: "/painel", minRole: "leitor", requiresSession: true, iconName: "Gauge" },

  { id: "page-curadoria", title: "Curadoria do catálogo", description: "a console: o que precisa da sua decisão", href: "/curadoria", minRole: "curador", requiresSession: true, iconName: "Wrench" },
  { id: "page-aieval", title: "Curadoria da Obra", description: "fila de atributos para avaliar", href: "/ai-evaluation", minRole: "curador", requiresSession: true, iconName: "Wrench" },
  { id: "page-aiusage", title: "Uso da API IA", description: "custo, tokens e chamadas por operação", href: "/ai-usage", minRole: "curador", requiresSession: true, iconName: "Activity" },
  { id: "page-metrics", title: "Métricas do modelo", description: "acurácia da Nota Prevista", href: "/admin/model-metrics", minRole: "curador", requiresSession: true, iconName: "ChartNoAxesCombined" },
  { id: "page-new", title: "Nova obra", description: "criar do zero ou buscar dados nas fontes", href: "/titles/new", minRole: "curador", requiresSession: true, iconName: "Plus" },
]
...
export function buildSearchIndex(): SearchEntry[] {
  ...
  const config: SearchEntry[] = SETTINGS_GROUPS.flatMap((g) =>
    g.sections.map((s) => ({
      ...
      href: `/settings?g=${g.id}&open=${s.id}`,
