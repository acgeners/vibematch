...
import { SETTINGS_GROUPS, findSection, groupIdOfSection } from "@/app/curation/settings/sections"
 ...
 *
 * Nada aqui é per-usuário, de propósito: é o que separa esta página do `/dashboard`
    ...
    <div className="w-full max-w-5xl">
      ...
      <div className="mb-7 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {/* O VALOR é o saldo, não o gasto: este tile é onde aterrissa o ponto colorido
            ...
            chamadas saiu; ela vive em /curation/ai-usage, que é o destino do clique. */}
        <Tile
      ...
      <section>
        ...
        <div className="grid gap-2.5 sm:grid-cols-2">
          <HealthCard
            ...
            href="/curation/settings?g=fontes"
          />
          <HealthCard
 ...
 * /curation/settings, cada uma linkando direto pro tópico dona.
 *
...
function buildDecisions(
  ...
  for (const [sectionId, count] of Object.entries(unread)) {
    ...
    rows.push({
      ...
      href: `/curation/settings?g=${groupId}&open=${sectionId}`,
      title: section.title,
