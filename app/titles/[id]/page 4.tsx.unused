...
export default async function TitleDetailPage({ params }: TitleDetailPageProps) {
  ...
  return (
    <div className="max-w-6xl space-y-6">
      {/* Botão Novo título fixo no canto superior direito */}
      ...
      <section className="grid gap-5 md:grid-cols-[220px_minmax(0,1fr)] lg:grid-cols-[240px_minmax(0,1fr)]">
        ...
        <div className="flex flex-col gap-3 w-full max-w-[220px] justify-self-center md:max-w-none md:justify-self-start">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            {" / "}
            <span className="font-mono">{work.total_chapters ?? "?"}</span>
            {" capítulos"}
          </p>
        </div>
                ...
                >
                  ...
                  <div className="flex flex-1 min-w-0 items-center justify-between gap-2">
                    ...
                    {score != null ? (
                      <span
                        className={cn(
                          "shrink-0 px-2 py-0.5 rounded text-xs font-mono font-semibold",
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              {bayesianAvg != null && (
                <div className="text-right shrink-0">
                  <p className="text-xs font-medium text-muted-foreground">Bayesiana geral</p>
                  <p className="text-lg font-bold font-mono">{bayesianAvg.toFixed(2)}</p>
