 ...
 *
 * A console `/curation` assumiu o que é do CATÁLOGO, e o que tinha ficado aqui virou
 * duplicata. Três blocos saíram, cada um por um motivo que não é só arrumação:
 *
 *   - **Custo IA (30d)** → `/curation/ai-usage`. `getAiUsageTotals()` **não filtra por usuário**: lia
 ...
 *   - **Fila "Atributos"** do card de pendências → `/curation/works`. Curadoria do catálogo.
 *     As outras duas filas ficaram: são as SUAS (`/my-ai-scores`).
 *
 ...
 * pessoais. Se um dia isso também couber em `/reading` e `/account/taste-profile`, o painel deixa de
