...
export default async function PreferenciasPage() {
  const { weights, config, weightsLastApplied } = await getPreferencesData()
  ...
  return (
    <div className="space-y-4">
      ...
      <PrefSection
        ...
        description="Percentis da distribuição que definem as cores das notas agregadas (Nota Prevista / Nota.IA / Nota.Pr)."
        icon={<Palette />}
        accent="amber"
      >
      ...
      <PrefSection
        ...
        description="Percentis por atributo (opcional). Cada atributo é colorido pela sua própria distribuição; herda os globais até você sobrescrever."
        icon={<Palette />}
        accent="amber"
      >
