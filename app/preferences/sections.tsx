...
import type { SettingsGroup, SettingsSection } from "@/app/curation/settings/sections"

// Registry das PREFERÊNCIAS pro console de duas camadas (mesmo modelo do /curation/settings:
...
//    a lista como argumento — diferente do /curation/settings, que tem registry estático). ──
