...
import { buildPreferencesGroups, PREFERENCES_DEFAULT_GROUP_ID } from "@/app/preferences/sections"
import { getCurrentPlan, isCurrentUserAdmin } from "@/server/queries/current-user"

// Layout de /preferences: navegação em DUAS CAMADAS (mesmo padrão do /curation/settings).
