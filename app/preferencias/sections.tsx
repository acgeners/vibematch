...
export function buildPreferencesGroups(plan: string): SettingsGroup[] {
  const rankingSections: SettingsSection[] = [
    {
      ...
      help: "Controla o recorte do Ranking: quantas obras exibir (top-N), a nota mínima padrão e os conjuntos de filtros que você salvou. Não muda como as notas são calculadas — só o que aparece na lista.",
      icon: Trophy,
    },
    {
      id: "tag-preferences",
