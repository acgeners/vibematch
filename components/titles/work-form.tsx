...
const FIELD_TAB_MAP: Record<string, EditTab> = {
  ...
  // Notas e avaliações
  romance: "notas", couple_dynamics: "notas",
  fantasy: "notas", setting_era: "notas",
  action_adventure: "notas", adult_content: "notas", protagonist: "notas",
  humor: "notas", drama: "notas", tragedy: "notas", angst: "notas",
  // LEGADO (migration 198): fora do producer, mas a curadoria ainda edita a nota histórica.
  fantasy_nobility: "notas", nobility: "notas",
...
const getEmptyCreateValues = (): Partial<WorkFormValues> => ({
  ...
  tragedy: null,
  angst: null,
  // LEGADO (198): aceito no form de curadoria, nunca produzido pela tool.
