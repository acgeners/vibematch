...
export const RANKING_TABLE_COLUMNS: RankingColumnDef[] = [
  ...
  { key: "synopsis_q", label: "Interesse", configLabel: "Interesse na sinopse", description: "O quanto a sinopse te interessou (♥ a ♥♥♥♥), informado na triagem/avaliação.", defaultWidth: 80, align: "center", group: "basico" },
  { key: "synopsis_pred", label: "Prev. Interesse", configLabel: "Previsão de interesse na sinopse", description: "A previsão da IA de quanto a sinopse vai te interessar (♥ a ♥♥♥♥), com base no seu perfil de gosto. Diferente da coluna \"Interesse\", que é o valor que VOCÊ informou. Só preenchida em obras que passaram pela estimativa (feature Paga). A confiança indica quão segura a IA está da estimativa.", defaultWidth: 110, align: "center", group: "basico" },
  { key: "ai_status", label: "IA", configLabel: "Status da avaliação IA", description: "Estágio da avaliação por IA: pendente de atributos, pendente de Veredito IA, avaliado ou pulado.", defaultWidth: 80, align: "center", group: "basico" },
  ...
  // embute o Alinhamento calibrado) + Veredito IA quando há. Exibida 0–100 = Decisão×10
  // (absoluta). Obras quase-empatadas se separam pela ORDEM (fit + bandas), não
  // por inflar o número. (Sort default agora é Prevista → Veredito IA → Alinhamento.)
