...
const EMPATE: BussolaDatum[] = [
  { workId: "grande", title: "Empatada com muitos votos", coverUrl: null, year: 2021, chanceScore: 68.0, platformAvg: 8.5, totalVotes: 30000, expectedScore: 8.5 },
  { workId: "pequena", title: "Empatada com poucos votos", coverUrl: null, year: 2022, chanceScore: 68.4, platformAvg: 8.54, totalVotes: 900, expectedScore: 8.4 },
  { workId: "outra", title: "Sozinha", coverUrl: null, year: 2020, chanceScore: 30, platformAvg: 7.2, totalVotes: 5000, expectedScore: 7.0 },
]
...
describe("BussolaPlane — obras empilhadas", () => {
  ...
  it("nunca atravessa a mediana — o quadrante dá a COR, e cor e posição não podem discordar", () => {
    ...
    const naMediana: BussolaDatum[] = [
      { workId: "1", title: "Baixa", coverUrl: null, year: 2020, chanceScore: 20, platformAvg: 6.0, totalVotes: 100, expectedScore: 6 },
      { workId: "2", title: "Empate A", coverUrl: null, year: 2021, chanceScore: 55, platformAvg: 8.0, totalVotes: 9000, expectedScore: 8 },
      { workId: "3", title: "Empate B", coverUrl: null, year: 2022, chanceScore: 55, platformAvg: 8.0, totalVotes: 300, expectedScore: 8 },
      { workId: "4", title: "Alta", coverUrl: null, year: 2023, chanceScore: 90, platformAvg: 9.2, totalVotes: 40000, expectedScore: 9 },
    ]
  ...
  it("não mexe em nada quando não há empate", () => {
    const semEmpate: BussolaDatum[] = [
      { workId: "a", title: "A", coverUrl: null, year: 2020, chanceScore: 20, platformAvg: 7.0, totalVotes: 100, expectedScore: 7 },
      { workId: "b", title: "B", coverUrl: null, year: 2021, chanceScore: 50, platformAvg: 8.0, totalVotes: 200, expectedScore: 8 },
      { workId: "c", title: "C", coverUrl: null, year: 2022, chanceScore: 80, platformAvg: 9.0, totalVotes: 300, expectedScore: 9 },
    ]
